...
def _compute_depth_and_confidence(depth_cue, confidence_method, peak_range=2, med_filt_size=3, quadratic_refinement=True):
...
def compute_depth_cues(
    ...
    compute_correspondence=True,
    compute_xcorrelation=False,
    ...
    window_filter = proc.get_smoothing_filter(window_size=window_size, window_shape=window_shape, plot_filter=plot_filter)
